Rails.application.config.after_initialize do
  ...
  Rails::HTML5::SafeListSanitizer.allowed_attributes.merge(%w[ data-creator-id data-only-visible-to-others data-only-visible-to-you data-turbo-frame data-lightbox-target data-lightbox-caption-value controls type width ])
